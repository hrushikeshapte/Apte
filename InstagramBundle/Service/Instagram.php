<?php
/**
 * This API was adapted from https://github.com/raket/laravel-instagram/blob/master/src/Raket/Instagram/Instagram.php
 * Created orignially by Marcus Dalgren. I have modified it as per my need.
*/

namespace Apte\InstagramBundle\Service;
